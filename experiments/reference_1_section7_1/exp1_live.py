...
def main():
    ...
    if args.detailed_timing:
        df_timing_raw = extract_timing_breakdown(df_raw, id_cols=["n", "rep", "method"])
        df_timing_sum = summarize_timing_breakdown(df_timing_raw, group_cols=["n"])
        timing_raw_csv = outdir / "exp1_timing_breakdown_raw.csv"
        timing_sum_csv = outdir / "exp1_timing_breakdown_summary.csv"
