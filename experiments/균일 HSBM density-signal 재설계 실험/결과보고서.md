...
- Gaussian RP의 test matrix는 `N(0, 1) / sqrt(K + oversampling)`으로 스케일링했습니다.
...
| --- | --- | --- | --- | --- | --- | --- |
| Non-random eigsh | baseline | 0.0973 | 0.7799 | 0.7357 | 0.7553 | 1.0000 |
| Gaussian RP r=30 q=1 | fast | 0.8210 | 0.0000 | 0.0012 | 0.6724 | 1.1234 |
| Gaussian RP r=160 q=3 | wide | 0.7988 | 0.0030 | 0.0052 | 2.2738 | 0.3322 |
| CountSketch RP r=30 q=1 | fast | 0.8225 | -0.0000 | 0.0011 | 0.4568 | 1.6536 |
| CountSketch RP r=160 q=3 | wide | 0.7973 | 0.0047 | 0.0076 | 2.0466 | 0.3691 |
| Random sampling p=0.3 | fast | 0.8222 | 0.0000 | 0.0023 | 1.1727 | 0.6441 |
| Random sampling p=0.7 | less_sparse | 0.6692 | 0.0526 | 0.0799 | 2.2235 | 0.3397 |
| Random sampling p=0.9 | near_full | 0.2483 | 0.4799 | 0.4948 | 1.1160 | 0.6768 |
| Random sampling p=1.0 | full_control | 0.0973 | 0.7799 | 0.7357 | 0.6977 | 1.0827 |
