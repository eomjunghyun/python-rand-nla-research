...
Pairwise ARI 수치를 읽을 때는 다음을 보면 된다.
...
여기서 실행시간은 8.1 스크립트 기준의 end-to-end 시간이다. 즉 randomized embedding 또는 eigenvector 계산 뒤 KMeans까지 포함한다. 따라서 8.2의 Table 4 스타일처럼 eigenvector computation만 따로 떼어 비교하는 시간표와는 목적이 다르다. Gaussian RP는 `N(0, 1) / sqrt(target_rank + r)` test matrix로 다시 실행했다. 절대 시간 자체보다는 같은 환경과 구현 안에서의 상대적 경향을 보는 것이 더 적절하다.

European email 결과는 다음과 같다.

| Rank | Methods | F1 | NMI | ARI | Time total sec |
|---|---|---:|---:|---:|---:|
| rank42 | Random Projection | 0.318(0.017) | 0.549(0.009) | **0.091(0.007)** | 1.023(0.392) |
| rank42 | CountSketch | 0.318(0.015) | 0.547(0.009) | 0.090(0.008) | **0.844(0.333)** |
| rank42 | Random Sampling (p=0.7) | 0.312(0.014) | 0.527(0.010) | 0.071(0.006) | 0.971(0.267) |
| rank42 | Random Sampling (p=0.8) | 0.325(0.014) | 0.540(0.007) | 0.074(0.008) | 0.916(0.302) |
| rank42 | Non-random | **0.351(0.014)** | **0.557(0.007)** | 0.082(0.006) | 0.951(0.276) |
| rank42 | SIGN Bidirectional | 0.309(0.009) | 0.542(0.010) | 0.090(0.010) | 1.341(0.970) |
| rank30 | Random Projection | 0.320(0.013) | 0.551(0.009) | **0.100(0.012)** | 0.909(0.324) |
| rank30 | CountSketch | 0.321(0.018) | 0.548(0.009) | 0.097(0.012) | **0.746(0.248)** |
| rank30 | Random Sampling (p=0.7) | 0.308(0.012) | 0.531(0.008) | 0.077(0.009) | 0.773(0.161) |
| rank30 | Random Sampling (p=0.8) | 0.326(0.014) | 0.543(0.006) | 0.082(0.007) | 0.968(0.174) |
| rank30 | Non-random | **0.353(0.013)** | **0.568(0.005)** | 0.094(0.010) | 0.826(0.191) |
| rank30 | SIGN Bidirectional | 0.317(0.018) | 0.548(0.008) | 0.095(0.009) | 1.116(0.682) |

Political blog 결과는 다음과 같다.

| Rank | Methods | F1 | NMI | ARI | Time total sec |
|---|---|---:|---:|---:|---:|
| rank2 | Random Projection | 0.576(0.000) | 0.178(0.000) | 0.080(0.000) | **0.252(0.097)** |
| rank2 | CountSketch | 0.576(0.000) | 0.178(0.000) | 0.080(0.000) | 0.262(0.072) |
| rank2 | Random Sampling (p=0.7) | 0.572(0.009) | 0.178(0.007) | 0.077(0.006) | 0.321(0.079) |
| rank2 | Random Sampling (p=0.8) | 0.572(0.004) | 0.178(0.005) | 0.077(0.003) | 0.286(0.100) |
| rank2 | Non-random | 0.576(0.000) | 0.178(0.000) | 0.080(0.000) | 0.309(0.107) |
| rank2 | SIGN Bidirectional | **0.576(0.000)** | **0.178(0.000)** | **0.080(0.000)** | 0.286(0.100) |
| rank5 | Random Projection | 0.435(0.004) | 0.042(0.006) | 0.002(0.001) | 0.367(0.146) |
| rank5 | CountSketch | 0.434(0.007) | 0.041(0.007) | 0.002(0.001) | **0.346(0.089)** |
| rank5 | Random Sampling (p=0.7) | 0.501(0.008) | 0.125(0.006) | 0.037(0.004) | 0.485(0.151) |
| rank5 | Random Sampling (p=0.8) | 0.499(0.007) | 0.125(0.005) | 0.037(0.003) | 0.449(0.091) |
| rank5 | Non-random | **0.502(0.000)** | **0.127(0.000)** | **0.038(0.000)** | 0.479(0.119) |
| rank5 | SIGN Bidirectional | 0.431(0.010) | 0.039(0.008) | 0.002(0.001) | 0.370(0.094) |

Statisticians coauthor 결과는 다음과 같다.

| Rank | Methods | F1 | NMI | ARI | Time total sec |
|---|---|---:|---:|---:|---:|
| rank3 | Random Projection | **1.000(0.000)** | **1.000(0.000)** | **1.000(0.000)** | 0.314(0.137) |
| rank3 | CountSketch | 0.998(0.007) | 0.996(0.019) | 0.997(0.011) | **0.266(0.082)** |
| rank3 | Random Sampling (p=0.7) | 0.873(0.205) | 0.786(0.190) | 0.835(0.198) | 0.345(0.124) |
| rank3 | Random Sampling (p=0.8) | 0.969(0.023) | 0.914(0.055) | 0.948(0.038) | 0.343(0.085) |
| rank3 | SIGN Bidirectional | 0.998(0.007) | 0.994(0.020) | 0.997(0.012) | 0.348(0.108) |
| rank5 | Random Projection | 0.991(0.023) | 0.978(0.051) | 0.985(0.036) | **0.345(0.144)** |
| rank5 | CountSketch | 0.992(0.023) | **0.982(0.049)** | 0.988(0.035) | 0.365(0.118) |
| rank5 | Random Sampling (p=0.7) | 0.816(0.245) | 0.766(0.151) | 0.810(0.172) | 0.365(0.098) |
| rank5 | Random Sampling (p=0.8) | 0.781(0.298) | 0.788(0.209) | 0.809(0.226) | 0.362(0.099) |
| rank5 | SIGN Bidirectional | **0.994(0.012)** | 0.982(0.034) | **0.989(0.020)** | 0.402(0.148) |

Statisticians citation 결과는 다음과 같다.

| Rank | Methods | F1 | NMI | ARI | Time total sec |
|---|---|---:|---:|---:|---:|
| rank3 | Random Projection | **0.984(0.005)** | **0.936(0.021)** | **0.973(0.011)** | 0.434(0.216) |
| rank3 | CountSketch | 0.984(0.005) | 0.935(0.018) | 0.972(0.009) | **0.401(0.219)** |
| rank3 | Random Sampling (p=0.7) | 0.937(0.010) | 0.797(0.024) | 0.899(0.016) | 0.530(0.250) |
| rank3 | Random Sampling (p=0.8) | 0.950(0.011) | 0.830(0.025) | 0.917(0.014) | 0.497(0.199) |
| rank3 | SIGN Bidirectional | 0.971(0.014) | 0.896(0.038) | 0.953(0.021) | 0.403(0.190) |
| rank5 | Random Projection | 0.898(0.124) | 0.752(0.267) | 0.794(0.267) | 0.341(0.251) |
| rank5 | CountSketch | **0.921(0.102)** | **0.797(0.225)** | **0.848(0.220)** | 0.297(0.194) |
| rank5 | Random Sampling (p=0.7) | 0.854(0.116) | 0.634(0.218) | 0.732(0.232) | 0.343(0.192) |
| rank5 | Random Sampling (p=0.8) | 0.835(0.132) | 0.602(0.261) | 0.685(0.266) | 0.277(0.150) |
| rank5 | SIGN Bidirectional | 0.805(0.131) | 0.548(0.263) | 0.610(0.264) | **0.265(0.183)** |

European email에서는 rank를 42에서 30으로 낮추면 대체로 총 실행시간이 줄어든다. 이번 재실행에서는 CountSketch가 email 두 rank에서 가장 짧은 end-to-end 시간을 보였고, 성능 최고값은 F1/NMI 기준으로 Non-random, ARI 기준으로 Random Projection에 걸려 있다.

Political blog와 statisticians 네트워크는 그래프 크기가 작아 전체 시간이 모두 짧다. 이 범위에서는 Random Projection, CountSketch, SIGN Bidirectional의 차이가 크지 않고, 최단 시간 method는 데이터셋과 rank별로 달라진다. Random Sampling은 edge sampling과 후속 spectral clustering 비용 때문에 대체로 빠른 그룹에 들지 못한다.
